...
module Nu
  module Agent
    module Commands
      module Workers
        # Command handler for exchange-summarizer worker
        class ExchangeSummarizerCommand
          WORKER_NAME = "exchange-summarizer"
          ...
          def enable_worker
            app.history.set_config("exchange_summarizer_enabled", "true")
          ...
          def disable_worker
            app.history.set_config("exchange_summarizer_enabled", "false")
          ...
          def change_model(new_model)
            app.history.set_config("exchange_summarizer_model", new_model)
            app.console.puts("")
          ...
          def change_verbosity(level)
            ...
            app.history.set_config("exchange_summarizer_verbosity", level)
            app.console.puts("")
          ...
          def reset_worker
            ...
            app.console.puts("")
            app.output_line("Cleared all exchange summaries", type: :command)
          end
          ...
          def help_text
            <<~HELP
              Exchange Summarizer Worker

              Summarizes individual exchanges in the background for improved RAG retrieval.
              ...
              Commands:
                ...
                /worker #{WORKER_NAME} reset          - Clear all exchange summaries
          ...
          def status_text
            ...
            model = app.history.get_config("exchange_summarizer_model")
            verbosity = app.history.get_int("exchange_summarizer_verbosity", default: 0)
