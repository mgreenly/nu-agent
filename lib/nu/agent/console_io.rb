  ...
  module Agent
    ...
    class ConsoleIO
      ...
      def redraw_input_line(prompt)
        @mutex.synchronize do
          do_redraw_input_line(prompt)
        end
      end

      def do_redraw_input_line(prompt)
      ...
      def handle_output_for_input_mode(prompt)
        ...
        @mutex.synchronize do
          ...
          # Redraw input using multiline-aware method (already in mutex, use private method)
          do_redraw_input_line(prompt)
