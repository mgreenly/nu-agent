  ...
  describe "#execute_subcommand" do
    ...
    context "with 'on' subcommand" do
      it "enables worker" do
        ...
        expect(console).to receive(:puts).with("")
        expect(application).to receive(:output_line).with("exchange-summarizer=on", type: :debug)
    ...
    context "with 'off' subcommand" do
      it "disables worker" do
        ...
        expect(console).to receive(:puts).with("")
        expect(application).to receive(:output_line).with("exchange-summarizer=off", type: :debug)
    ...
    context "with 'start' subcommand" do
      it "starts worker" do
        ...
        expect(console).to receive(:puts).with("")
        expect(application).to receive(:output_line).with("Starting exchange-summarizer worker", type: :debug)
    ...
    context "with 'stop' subcommand" do
      it "stops worker" do
        ...
        expect(console).to receive(:puts).with("")
        expect(application).to receive(:output_line).with("Stopping exchange-summarizer worker", type: :debug)
